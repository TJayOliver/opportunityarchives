...
const Administrator = () => {
  ...
  return (
    ...
    >
      ...
      {state?.error && (
        <div className="flex items-center mt-2 mb-4 h-10 pl-3 border border-slate-300 rounded-full focus-within:ring-2 focus-within:ring-indigo-400 transition-all overflow-hidden bg-gray-200 w-full text-center font-medium justify-center text-red-600">
          <p>{state.error}</p>
        </div>
      )}
